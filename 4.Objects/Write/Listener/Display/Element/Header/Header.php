...
class Header
	{
	public $strHTML;
	public function __construct($_objKIIM, $_str, $_arrSearch, $_strBitrate=0, $_strCodec='n/a')
		{
			...
			<header
				...
				<nextBlockTitle
					...
					<blockText
						...
						>
						<ifEN>
							Declared styles by station:
						</ifEN>
						<ifRU>
							Заявленные станцией стили:
						</ifRU>
					</blockText>
					<rightBufferBlock 
						class="block right TC2 BC2"
	...
	public static function strHTML($_objKIIM, $_str, $_arrSearch, $_strBitrate=0, $_strCodec='n/a')
		{
		$objHeader=new Header($_objKIIM, $_str, $_arrSearch, $_strBitrate, $_strCodec);
